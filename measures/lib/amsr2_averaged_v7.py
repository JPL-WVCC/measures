...
class ThreedayVerify(Verify):
    ...
    def __init__(self,dataset):
        self.filename = 'verify_amsr2_v7.2.txt'
        self.ilon1 = 170
        self.ilon2 = 175
        self.ilat1 = 274
        self.ilat2 = 278                
...
if __name__ == '__main__':
    ...
    # read 3-day averaged:
    amsr = AMSR2averaged('F34_20130915v7.2_d3d.gz')
    ...
    amsr = AMSR2averaged('F34_20130921v7.2.gz')
    if not amsr.variables: sys.exit('problem reading file')
    ...
    amsr = AMSR2averaged('F34_201309v7.2.gz')
    if not amsr.variables: sys.exit('problem reading file')
